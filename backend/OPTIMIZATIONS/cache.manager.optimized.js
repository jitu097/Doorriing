/**
 * OPTIMIZED CACHE MANAGER - Increased Cache Size Configuration
 *
 * Changes from original:
 * - maxSize: 100 → 500 (5x larger cache)
 * - Better hit rate for shops, items, categories
...
class CacheManager {
  constructor() {
    ...
    // OPTIMIZATION: Increased from 100 to 500
    this.maxSize = 500;
  }
  ...
  getStats() {
    ...
    return {
      ...
      cacheFullness: `${((this.cache.size / this.maxSize) * 100).toFixed(1)}%`,
    };
  }
