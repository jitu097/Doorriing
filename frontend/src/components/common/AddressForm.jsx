...
const AddressForm = ({ formData, setFormData, onSubmit, onCancel, isEditing }) => {
    ...
    const deliveryAreas = ['Dhrampur', 'Jublee Chowk', 'Thana Chowk', 'Bypass', 'Bustand', 'Mako', 'Station','Chatnahi' , 'Station road', 'Navoday', 'Mako', 'Bus Stand', 'Circuit House' , 'Block', 'charmuhan',  'shivpuri','Main road latehar','Bijlee ofice', ' Near Celebration','Navrang chowk','Gandhi college','BS college'];
